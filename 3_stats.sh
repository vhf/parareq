...
s200=$(grep -E '^200' ./output/2_good | wc -l | column -t | cut -d' ' -f1)
s200xml=$(grep -E '^200.*\t.*\t.*xml.*$' ./output/2_good | wc -l | column -t | cut -d' ' -f1)
s200xmlu=$(grep -E '^200.*\t.*\t.*xml.*$' ./output/2_good | uniq | wc -l | column -t | cut -d' ' -f1)
